...
cpt_df.write.format('delta').save(f"{delta_path}/silver/cpt")
...
# MAGIC |Seaborn |BSD 3-Clause | https://github.com/seaborn/seaborn/blob/master/LICENSE | https://github.com/seaborn/seaborn/|
